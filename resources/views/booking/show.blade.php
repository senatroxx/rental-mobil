            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="tgl_sewa" aria-describedby="tgl_sewa" name="tgl_sewa" onchange="getDiff()" disabled value="{{ $sewa->tgl_sewa }}">
                    </div>
                    <div class="form-group">
                        <label for="tgl_selesai">Tanggal Selesai</label>
                        <input type="date" class="form-control" id="tgl_selesai" aria-describedby="tgl_selesai" name="tgl_selesai" onchange="getDiff()" disabled value="{{ $sewa->tgl_selesai }}">
                    </div>
                    <div class="form-group">
